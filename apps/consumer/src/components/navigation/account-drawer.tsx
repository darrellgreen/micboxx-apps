...
export function AccountDrawerProvider({ children }: PropsWithChildren) {
  ...
  const contextValue = useMemo(() => ({ openDrawer, closeDrawer }), [closeDrawer, openDrawer]);
    ...
    <AccountDrawerContext.Provider value={contextValue}>
      ...
      {isMounted ? (
        <View style={styles.overlayRoot} pointerEvents="box-none">
          ...
          <Animated.View
            style={[styles.panelWrap, { transform: [{ translateX: panelTranslateX }] }]}
          >
            <SafeAreaView style={styles.panel} edges={['bottom']}>
              <View style={[styles.panelContent, { paddingTop: Math.max(insets.top, 12) + 28 }]}>
                <Animated.View
                  style={{
                    flex: 1,
                ...
                >
                  ...
                  >
                    ...
                    <DrawerSection title="Settings and Privacy" variant="plain">
  ...
  return (
    <View style={styles.section}>
      ...
      <View
        style={[
          styles.sectionBody,
          variant === 'prominent' ? styles.sectionBodyProminent : styles.sectionBodyPlain,
        ]}
      >
        {children}
      </View>
    ...
    >
      ...
      <View style={styles.itemCopy}>
        <Text
          style={[
            styles.itemLabel,
            variant === 'prominent' ? styles.itemLabelProminent : styles.itemLabelPlain,
