...
interface GenresIconProps {
  size?: number;
  color?: string;
}

export function GenresIcon({ size = 20, color = "#fff" }: GenresIconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path
        ...
        strokeWidth={1.5}
      />
      <Path d="M9 19V8" stroke={color} strokeWidth={1.5} />
      <Path d="M21 17V6" stroke={color} strokeWidth={1.5} />
      <Path
