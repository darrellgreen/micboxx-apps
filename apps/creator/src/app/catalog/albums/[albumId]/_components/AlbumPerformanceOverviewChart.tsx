...
export function AlbumPerformanceOverviewChart() {
  // Hardcoded coordinates to match the mockup line exactly
  const mockupValues = [100, 180, 360, 220, 120, 170, 255];
  ...
  const maxValue = 400; // Matching mockup scale (0 - 400)
  const minValue = 0;
  ...
  const gridValues = [400, 300, 200, 100, 0];
